  ...
  function (module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          ...
          var minSrc = 'https://raw.githubusercontent.com/messi1002/messi-photos/master/min_photos/' + data.link[i];
          var src = 'https://raw.githubusercontent.com/messi1002/messi-photos/master/photos/' + data.link[i];
          ...
          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">\
                  <a href="' + target + '" itemprop="contentUrl" data-size="1080x1080" data-type="' + type + '" data-target="' + target + '">\
                    <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="../lib/album1/assets/empty.png" itemprop="thumbnail" onload="lzld(this)">\
                  </a>\
    ...
    function loadData(success) {
      if (!searchData) {
        ...
        xhr.open('GET', '../lib/album1/data.json?t=' + +new Date(), true);
